        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                PC3.ToolButton {
                    ...
                    opacity: panel.alignment !== Qt.AlignCenter ? 1.0 : 0.0
                    enabled: panel.alignment !== Qt.AlignCenter
                    onClicked: panel.alignment = Qt.AlignCenter
                    PC3.ToolTip.text: i18ndc("plasma_shell_org.kde.plasma.desktop", "@info:tooltip", "Reset to default")
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                PC3.ToolButton {
                    icon.name: "edit-reset"
                    display: AbstractButton.IconOnly
                    opacity: panel.lengthMode !== Panel.Global.FillAvailable ? 1.0 : 0.0
                    enabled: panel.lengthMode !== Panel.Global.FillAvailable
                    onClicked: {
                        panel.lengthMode = Panel.Global.FillAvailable
                        panelConfiguration.panelRulerView.visible = false
                    }
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                PC3.ToolButton {
                    icon.name: "edit-reset"
                    display: AbstractButton.IconOnly
                    opacity: panel.visibilityMode !== Panel.Global.NormalPanel ? 1.0 : 0.0
                    enabled: panel.visibilityMode !== Panel.Global.NormalPanel
                    onClicked: panel.visibilityMode = Panel.Global.NormalPanel
                    PC3.ToolTip.text: i18ndc("plasma_shell_org.kde.plasma.desktop", "@info:tooltip", "Reset to default")
                    PC3.ToolTip.delay: Kirigami.Units.toolTipDelay
                    PC3.ToolTip.visible: hovered
                }
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                PC3.ToolButton {
                    icon.name: "edit-reset"
                    display: AbstractButton.IconOnly
                    opacity: panel.opacityMode !== Panel.Global.Adaptive ? 1.0 : 0.0
                    enabled: panel.opacityMode !== Panel.Global.Adaptive
                    onClicked: panel.opacityMode = Panel.Global.Adaptive
                    PC3.ToolTip.text: i18ndc("plasma_shell_org.kde.plasma.desktop", "@info:tooltip", "Reset to default")
                    PC3.ToolTip.delay: Kirigami.Units.toolTipDelay
                    PC3.ToolTip.visible: hovered
                }
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                PC3.ToolButton {
                    icon.name: "edit-reset"
                    display: AbstractButton.IconOnly
                    opacity: (panel.floating || panel.floatingApplets) ? 1.0 : 0.0
                    enabled: panel.floating || panel.floatingApplets
                    onClicked: { panel.floating = false; panel.floatingApplets = false }
                    PC3.ToolTip.text: i18ndc("plasma_shell_org.kde.plasma.desktop", "@info:tooltip", "Reset to default")
                    PC3.ToolTip.delay: Kirigami.Units.toolTipDelay
                    PC3.ToolTip.visible: hovered
                }
    ...
    GridLayout {
        ...
        RowLayout {
            ...
            PC3.ToolButton {
                icon.name: "edit-reset"
                display: AbstractButton.IconOnly
                opacity: panel.thickness !== 44 ? 1.0 : 0.0
                enabled: panel.thickness !== 44
                onClicked: panel.thickness = 44
                PC3.ToolTip.text: i18ndc("plasma_shell_org.kde.plasma.desktop", "@info:tooltip", "Reset to default")
                PC3.ToolTip.delay: Kirigami.Units.toolTipDelay
                PC3.ToolTip.visible: hovered
            }
